customElements.define('x-frame-bypass', class extends HTMLIFrameElement {
    ...
    load (url, options) {
        if (!url || !url.startsWith('http'))
            throw new Error(`src ${url} does not start with http(s)://`)
...
<body>
    ...
    <base href="${url}">
    <script>
    // X-Frame-Bypass nav event handlers
    ...
    fetchProxy (url, options, i) {
        const proxy = [ 'https://cors.io/?', 'https://jsonp.afeld.me/?url=', 'https://cors-anywhere.herokuapp.com/' ]
